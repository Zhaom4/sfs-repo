...
function Donations(){
  ...
  const buttonInteractions = useCursorInteractions();
  ...
  return (
    ...
    <div className={styles.container}>
      ...
      <section className={styles["mission-container"]}>
        ...
        <h1 className={styles["mission-statement"]}
        onMouseEnter={hover}
        onMouseLeave={resetCursor}
        ref={missionRef}
        >
          ...
          Students for Students is a nonprofit organization that fights income
          inequality by providing <span className={styles.highlight}>affordable, high quality education.</span>{" "}
        </h1>
      </section>
      ...
      <section className={styles["body1"]}>
        ...
        <div className={styles["reason-container"]}>
          <div className={styles.reason}>
            ...
            >affordable education</h3>
            <div className={styles['lib-img']}></div>
